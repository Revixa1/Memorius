 ...
 * this stuff is worth it, you can buy a beer to Thomas-Xavier Guimont  (aka: TX) or a montain dew in the case of Marc-Olivier Fecteau (aka: Professeur Marco)  in return
 * ----------------------------------------------------------------------------
 */
